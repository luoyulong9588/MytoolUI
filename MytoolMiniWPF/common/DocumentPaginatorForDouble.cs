...
namespace MytoolMiniWPF.common
{
    class DocumentPaginatorForDouble : DocumentPaginator
    {
        ...
        public DocumentPaginatorForDouble(Patient patient, int x, int y, MyFontSyle fontStyle)
        {
            _patient = patient;
        ...
        {
            var formattedTxt = new FormattedText(txt, CultureInfo.CurrentCulture, FlowDirection.LeftToRight, new Typeface(_fontFamily), _fontSize, Brushes.Black);
