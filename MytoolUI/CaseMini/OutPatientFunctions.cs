...
namespace MytoolUI
{
    public partial class CaseUIMini
    {
        ...
        private void StartFormatFile(DataTable dataTable)
        {
            ...
            for (int i = 4; i < rows - 3; i++)
            {
                ...
                dbInfo.SaveInfoToDb(doctorName,painName,gender,age,phone,vocation,idCard,workAddress,nowAddress,comeDate,diaseDate,bloodPressure,mainChef,diagMemory,mainDrug);
            }
        }
